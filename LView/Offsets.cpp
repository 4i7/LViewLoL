...
int Offsets::GameTime = 0x2FADB80;
...
int Offsets::ObjSpellBook = 0x2880;
...
int Offsets::ObjItemList = 0x3414;

int Offsets::ItemListItem = 0xC;
int Offsets::ItemInfo = 0x20;
int Offsets::ItemInfoId = 0x68;

int Offsets::ViewProjMatrices = 0x2FD92A8;
int Offsets::Renderer = 0x2FDC11C;
...
int Offsets::ObjectManager = 0x1719438;
int Offsets::LocalPlayer = 0x2FB5814;
int Offsets::UnderMouseObject = 0x2FAA1F8;
...
int Offsets::MinimapObject = 0x2FB5810;
